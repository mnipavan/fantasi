...
B0Param = 1.0
vScaleFac = 100.0
drdt=Expression("aFac*( (A0 * aParm * exp(-aParm * x[0])) - (B0 * bParm * exp(bParm * (x[0] - 1.0))) )",aFac = vScaleFac, aParm = aParam, bParm = bParam, A0 = A0Param, B0 = B0Param, degree=3)

#### Create VTK file for saving solution
vtkfile = File('DoubleExponentialTransient/solution.pvd')
